...
export type Permission=
 ...
 "duel.review"|"mastery.configure"|"settings.manage"|"audit.view"|"stats.view";
...
export function permissionsFor(role:Role,granted:Permission[]=[]){
 if(role==="owner")return new Set<Permission>([...ADMIN_DEFAULTS,"problem.delete","user.suspend","user.manage_roles","roadmap.manage","lesson.manage","quiz.manage","duel.review","mastery.configure","settings.manage","audit.view","stats.view"]);
