...
export function AuthPage({lang,done,notice}:{lang:Lang;done:(token?:string)=>void;notice?:string}){
 const [mode,setMode]=useState<"login"|"signup"|"confirm">("login"),[email,setEmail]=useState(""),[password,setPassword]=useState(""),[password2,setPassword2]=useState(""),[username,setUsername]=useState(""),[message,setMessage]=useState(notice||""),[busy,setBusy]=useState(false),[show,setShow]=useState(false),[remember,setRemember]=useState(true);
