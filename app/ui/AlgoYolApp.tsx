...
type Lang="uz"|"en"; type View="home"|"roadmaps"|"roadmap"|"problems"|"problem"|"duel"|"leaderboard"|"profile"|"auth"|"admin"|"placement"|"stats";
...
export function AlgoYolApp(){
 ...
 const pathToScreen=(path:string):{view:View;roadmap:string;unit:string|null}=>{
  ...
  const known:View[]=["home","roadmaps","problems","problem","duel","leaderboard","profile","auth","placement","admin","stats"];
