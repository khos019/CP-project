...
P.push({
  ...
  statementUz: "Sizga n ta butun sondan iborat massiv berilgan. Eng katta element turgan pozitsiyani chiqaring; pozitsiyalar 1 dan boshlab sanaladi. Agar eng katta qiymat bir necha joyda uchrasa, ularning eng chapdagisini, ya'ni eng kichik pozitsiyasini chiqaring. Massivda manfiy sonlar ham bo‘lishi mumkin va qiymatlar xohlagancha ko‘p takrorlanishi mumkin.",
  statementEn: "You are given an array of n integers. Print the position at which the largest element sits, with positions counted from 1. If the largest value occurs in several places, print the leftmost of them, that is the smallest such position. The array may contain negative numbers, and the values may repeat any number of times.",
...
P.push({
  ...
  statementUz: "Sizga n ta butun sondan iborat massiv berilgan. Uning barcha elementlari bir xil qiymatga tengmi, aniqlang. Bitta elementdan iborat massivda solishtiradigan narsa yo‘q, shuning uchun u har doim shartni qanoatlantiradi. Qiymatlar manfiy bo‘lishi mumkin va massivning istalgan joyida turgan bitta farqli element shartni buzishi uchun yetarli.",
  statementEn: "You are given an array of n integers. Determine whether all of its elements hold the same value. An array of one element has nothing to compare, so it always satisfies the condition. The values may be negative, and a single differing element anywhere in the array is enough to break the condition.",
  inputUz: "Birinchi qatorda bitta n butun soni beriladi. Ikkinchi qatorda probel bilan ajratilgan n ta butun son keladi.",
  inputEn: "The first line contains one integer n. The second line contains n integers separated by single spaces.",
...
P.push({
  ...
  statementUz: "Sizga n ta butun sondan iborat massiv berilgan. i < j shartini qanoatlantiruvchi va a_i + a_j yig‘indisi juft bo‘lgan (i, j) juftliklar sonini toping. Juftlik qiymatlar bilan emas, ikkita pozitsiya bilan aniqlanadi, ya'ni har xil joyda turgan teng sonlar har xil juftlik hosil qiladi. Javob 32-bitli turdan oshib ketadi.",
  statementEn: "You are given an array of n integers. Count the pairs (i, j) with i < j whose sum a_i + a_j is even. The pair is named by two positions rather than by values, so equal numbers standing in different places form different pairs. The count runs beyond a 32-bit type.",
  inputUz: "Birinchi qatorda bitta n butun soni beriladi. Ikkinchi qatorda probel bilan ajratilgan n ta butun son keladi.",
  inputEn: "The first line contains one integer n. The second line contains n integers separated by single spaces.",
...
P.push({
  ...
  statementUz: "Sizga n ta butun sondan iborat massiv berilgan. Bitta harakatda istalgan bitta elementni bir birlikka oshirish mumkin. Barcha elementlarni teng qilish uchun kerak bo‘ladigan eng kam harakatlar sonini toping. Faqat oshirishga ruxsat beriladi, kamaytirishga emas, va hamma tenglashadigan qiymat oldindan berilmaydi.",
  statementEn: "You are given an array of n integers. One move increases any single element by one. Find the smallest number of moves needed to make every element equal. Only increases are allowed, never decreases, and the value everything ends up at is not given in advance.",
  inputUz: "Birinchi qatorda bitta n butun soni beriladi. Ikkinchi qatorda probel bilan ajratilgan n ta butun son keladi.",
  inputEn: "The first line contains one integer n. The second line contains n integers separated by single spaces.",
...
P.push({
  ...
  statementUz: "Sizga tekislikdagi n ta nuqta berilgan. Ularning istalgan ikkitasi orasidagi eng katta Manhattan masofasini toping; ikki nuqta orasidagi Manhattan masofasi |x₁ − x₂| + |y₁ − y₂| ga teng. Nuqtalar takrorlanishi mumkin — bunday juftlik orasidagi masofa 0 bo‘ladi — va koordinatalar manfiy bo‘lishi mumkin.",
  statementEn: "You are given n points in the plane. Find the largest Manhattan distance between any two of them, where the Manhattan distance between two points is |x₁ − x₂| + |y₁ − y₂|. The points may repeat, in which case the distance between that pair is 0, and the coordinates may be negative.",
