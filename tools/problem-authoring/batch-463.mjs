...
P.push({
  ...
  statementUz: "Arifmetik progressiya birinchi hadi a, qadami d bo‘lgan ketma-ketlikdir: a, a + d, a + 2d va hokazo. Sizga a, d va n berilgan; dastlabki n ta hadning yig‘indisini toping. Qadam manfiy yoki nol bo‘lishi ham mumkin. Yig‘indi manfiy bo‘lishi mumkin va 32-bitli turdan ancha oshadi, shuning uchun 64-bitli tur kerak.",
  statementEn: "An arithmetic progression is the sequence a, a + d, a + 2d and so on, starting at a with a step of d. Given a, d and n, find the sum of the first n terms. The step may be negative or zero. The sum may be negative and runs far beyond a 32-bit type, so it needs a 64-bit one.",
...
P.push({
  ...
  statementUz: "Sizga musbat n soni berilgan. Bitta qadamda uchta amaldan birini bajarish mumkin: sonni bittaga kamaytirish; agar u ikkiga bo‘linsa, ikkiga bo‘lish; agar u uchga bo‘linsa, uchga bo‘lish. n dan 1 ga tushish uchun kerak bo‘ladigan eng kam qadamlar sonini toping. 1 uchun birorta qadam kerak emas va bo‘lish faqat qoldiqsiz bo‘lganda mumkin.",
  statementEn: "You are given a positive number n. In one step you may do one of three things: lower the number by one; halve it, if it is divisible by two; or divide it by three, if it is divisible by three. Find the fewest steps that bring n down to 1. The number 1 needs no step at all, and a division is possible only when it leaves no remainder.",
...
P.push({
  ...
  statementUz: "Sizga n ta uch va m ta qirra berilgan; har bir qirra o‘ziga xos t vaqtida paydo bo‘ladi va undan keyin abadiy qoladi. Grafdagi barcha uchlar o‘zaro bog‘lanadigan eng erta vaqtni toping. Ikkala uchi allaqachon bog‘langan paytda kelgan qirra hech narsani o‘zgartirmaydi. Hech qachon bog‘lanmasa, −1 chiqaring.",
  statementEn: "You are given n vertices and m edges, each appearing at its own time t and staying forever after. Find the earliest time at which every vertex is connected to every other. An edge that arrives when both of its ends are already connected changes nothing. If that never happens, print −1.",
