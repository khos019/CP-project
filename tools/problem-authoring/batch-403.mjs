...
P.push({
  ...
  statementUz: "Tekislikda n ta har xil nuqta berilgan. Bitta to‘g‘ri chiziqda yotadigan nuqtalarning eng ko‘p sonini toping. Ikkita nuqta orqali har doim to‘g‘ri chiziq o‘tkazish mumkin, shuning uchun javob hech qachon 2 dan kichik bo‘lmaydi. Har bir nuqtani tayanch sifatida olib, undan chiqqan yo‘nalishlarni qisqartirilgan ko‘rinishda sanash kifoya.",
  statementEn: "You are given n distinct points in the plane. Find the largest number of them that lie on one straight line. A line can always be drawn through two points, so the answer is never below 2. It is enough to take each point as an anchor and count the directions leading from it, each reduced to lowest terms.",
...
P.push({
  ...
  statementUz: "Sizda n ta ishchi va n ta vazifa bor. Jadvalning i-satri j-ustunidagi 1 raqami i-ishchi j-vazifani bajara olishini, 0 esa bajara olmasligini bildiradi. Har bir ishchiga aynan bitta vazifa, har bir vazifaga esa aynan bitta ishchi to‘g‘ri keladigan taqsimotlar nechta ekanini 10^9 + 7 modul bo‘yicha sanang. Band qilingan vazifalar to‘plamini bitlar bilan saqlash mumkin, chunki n kichik.",
  statementEn: "You have n workers and n tasks. A 1 in row i, column j of the table means worker i can do task j, and a 0 means they cannot. Count, modulo 10^9 + 7, the assignments that give each worker exactly one task and each task exactly one worker. The set of taken tasks fits in a bitmask, since n is small.",
