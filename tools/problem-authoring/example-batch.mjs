...
P.push({
  ...
  sampleNotesEn: [
    "There are three proper borders: \"a\" (1), \"aa\" (2) and \"aabaa\" (5), each appearing at both ends of the string. They form a chain: the border of 5 is 2, and the border of 2 is 1. \"aab\" (3) is not one, because the string ends in \"baa\".",
