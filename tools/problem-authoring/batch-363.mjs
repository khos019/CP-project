...
P.push({
  ...
  statementUz: "Sizga n kun davomidagi narxlar berilgan. Bir marta sotib olib, keyinroq bir marta sotishingiz mumkin — sotish kuni sotib olish kunidan qat'iy keyin bo‘lishi shart. Eng katta foydani toping. Agar har qanday tanlovda foyda manfiy chiqsa, umuman savdo qilmaslik ham mumkin; bunday holda foyda 0 bo‘ladi. Har bir kunda o‘sha kungacha ko‘rilgan eng past narxni eslab qolish kifoya.",
  statementEn: "You are given the prices over n days. You may buy once and sell once later, with the selling day strictly after the buying day. Find the largest profit. If every choice would lose money you may simply not trade, in which case the profit is 0. Remembering the lowest price seen so far on each day is enough.",
...
P.push({
  ...
  statementUz: "Sizga kichik lotin harflaridan iborat s satri berilgan. Undan eng kam nechta harfni o‘chirsak, qolgan harflar o‘z tartibida palindrom hosil qiladi? O‘chirilmagan harflarning tartibi o‘zgarmaydi. Javob satr uzunligidan uning eng uzun palindromik qism ketma-ketligi uzunligini ayirgan natijaga teng, chunki saqlanib qoladigan harflar aynan shu qism ketma-ketlikni tashkil qiladi.",
  statementEn: "You are given a string s of lowercase Latin letters. What is the fewest letters that can be deleted so that the remaining letters, in their original order, form a palindrome? The letters that survive keep their order. The answer is the length of the string minus the length of its longest palindromic subsequence, because those surviving letters are exactly such a subsequence.",
