...
P.push({
  ...
  statementUz: "Sizga musbat n butun soni berilgan. 1 dan n gacha bo‘lgan barcha butun sonlar yig‘indisini, ya'ni 1 + 2 + 3 + … + n qiymatini toping. Bu son n-chi uchburchak son deb ataladi. n 10^9 gacha borgani uchun hadlarni birma-bir qo‘shadigan tsikl vaqtida tugamaydi, javobning o‘zi esa 32-bitli turdan toshib ketadi.",
  statementEn: "You are given a positive integer n. Find the sum of all integers from 1 to n, that is the value of 1 + 2 + 3 + … + n. This number is called the n-th triangular number. Since n goes up to 10^9, a loop adding the terms one at a time will not finish in time, and the answer itself overflows a 32-bit type.",
...
P.push({
  ...
  statementUz: "Sizga uchta butun son l, r va k berilgan. l dan r gacha bo‘lgan oraliqda (ikkala chet ham kiradi) k ga qoldiqsiz bo‘linadigan nechta son borligini toping. Ikkala chegara ham oraliqqa kiradi, l manfiy bo‘lishi mumkin, k esa har doim musbat. Oraliqda karrali son bo‘lmasa, javob 0 bo‘ladi.",
  statementEn: "You are given three integers l, r and k. Find how many numbers in the range from l to r inclusive are divisible by k without a remainder. Both ends belong to the range, l may be negative, and k is always positive. The count is 0 when the range holds no multiple at all.",
...
P.push({
  ...
  statementUz: "Sizga kichik lotin harflaridan iborat s satri berilgan. Satrda aynan bir marta uchraydigan harflar orasidan eng chapdagisining pozitsiyasini toping. Pozitsiyalar 1 dan sanaladi. Ikki yoki undan ko‘p marta uchraydigan harf, uchrashlari qanchalik uzoqda turmasin, mos kelmaydi; satrda probel umuman bo‘lmaydi.",
  statementEn: "You are given a string s of lowercase Latin letters. Among the letters that occur exactly once in it, find the position of the leftmost one. Positions are counted from 1. A letter occurring twice or more never qualifies, however far apart its occurrences stand, and the string never holds a space.",
