...
P.push({
  ...
  statementUz: "Sizga ikkita L va R chegarasi berilgan. L dan R gacha bo‘lgan oraliqda, ikkala chegarani ham qo‘shgan holda, nechta tub son borligini sanang. Tub son deganda faqat 1 ga va o‘ziga bo‘linadigan, birdan katta son tushuniladi; shuning uchun 1 tub emas, 2 esa tub. R katta bo‘lgani uchun har bir sonni alohida tekshirish o‘rniga elakdan foydalangan ma'qul.",
  statementEn: "You are given two bounds L and R. Count the primes in the range from L to R, both bounds included. A prime is a number above one divisible only by 1 and itself, so 1 is not prime while 2 is. Since R is large, a sieve serves better than testing each number on its own.",
...
P.push({
  ...
  statementUz: "Sizga n ta musbat butun sondan iborat massiv va s chegarasi berilgan. Ketma-ket turgan shunday eng uzun qismni toping-ki, undagi elementlarning yig‘indisi s dan oshmasin, va uning uzunligini chiqaring. Barcha elementlar musbat bo‘lgani uchun oynani o‘ngga surib, chegaradan oshganda chapdan qisqartirish kifoya. Birorta element ham s ga sig‘masa, javob 0 bo‘ladi.",
  statementEn: "You are given an array of n positive integers and a bound s. Find the longest stretch of consecutive elements whose sum does not exceed s, and print its length. Since every element is positive, sliding a window to the right and shrinking it from the left whenever the bound is passed is enough. If not even a single element fits within s, the answer is 0.",
...
P.push({
  ...
  statementUz: "2 satr va n ustundan iborat maydonni 1 × 2 o‘lchamli plitkalar bilan to‘liq qoplash kerak. Plitkani yotiq yoki tik qo‘yish mumkin, ular bir-birining ustiga tushmasligi va maydondan chiqmasligi shart. Qoplash usullari nechtaligini 10^9 + 7 modul bo‘yicha sanang. n katta bo‘lgani uchun javobni rekurrent munosabat orqali qurish kerak.",
  statementEn: "A board of 2 rows and n columns must be covered completely by tiles of size 1 by 2. A tile may lie flat or stand upright, and the tiles may not overlap or hang off the board. Count the ways to cover it, modulo 10^9 + 7. Since n is large, the answer has to be built up through a recurrence.",
...
P.push({
  ...
  statementUz: "2n ta nomzod bor; i-nomzodni birinchi shaharga yuborish a_i, ikkinchisiga yuborish esa b_i turadi. Har bir shaharga aynan n tadan nomzod yuborilishi shart. Umumiy xarajatni eng kichik qiladigan taqsimotni toping va o‘sha xarajatni chiqaring. Hammani birinchi shaharga yuborgandek hisoblab, so‘ng ikkinchisiga o‘tkazish foydasi bo‘yicha tartiblab, eng foydali n tasini o‘tkazish kifoya.",
  statementEn: "There are 2n candidates; sending candidate i to the first city costs a_i and to the second costs b_i. Exactly n candidates must go to each city. Find the assignment with the smallest total cost and print that cost. Pricing everyone as if they went to the first city, then sorting by what moving them to the second would save, and moving the best n of them, is enough.",
...
P.push({
  ...
  statementUz: "Sizga kichik lotin harflaridan iborat s satri berilgan. Unda kamida ikki marta uchraydigan eng uzun qism satrning uzunligini toping. Uchrashlar ustma-ust tushishi ham mumkin, ya'ni aaa satrida aa ikki marta uchraydi. Bunday qism umuman bo‘lmasa, javob 0 bo‘ladi. Uzunlik bo‘yicha ikkilik qidiruv qilib, har bir uzunlikdagi qismlarning xeshlarini solishtirish kifoya.",
  statementEn: "You are given a string s of lowercase Latin letters. Find the length of the longest substring that occurs in it at least twice. The occurrences may overlap, so aa occurs twice in aaa. If no such substring exists the answer is 0. Binary searching on the length and comparing the hashes of the substrings of that length is enough.",
