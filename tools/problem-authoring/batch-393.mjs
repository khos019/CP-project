...
P.push({
  ...
  statementUz: "Sizga n butun soni berilgan. 1³ + 2³ + … + n³ yig‘indisini 10^9 + 7 modul bo‘yicha hisoblang. n 10^18 gacha borgani uchun hadlarni birma-bir qo‘shib bo‘lmaydi: bu yig‘indi (n(n+1)/2)² ga teng, ya'ni dastlabki n ta sonning yig‘indisining kvadrati. Modul ostida ikkiga bo‘lish uchun 2 ning modul teskarisiga ko‘paytirish kerak.",
  statementEn: "You are given an integer n. Compute 1³ + 2³ + … + n³ modulo 10^9 + 7. Since n goes up to 10^18 the terms cannot be added one at a time: the sum equals (n(n+1)/2)², the square of the sum of the first n numbers. Dividing by two under a modulus means multiplying by the modular inverse of 2.",
...
P.push({
  ...
  statementUz: "Sizga kichik lotin harflaridan iborat s satri berilgan. Uning harflarini qayta joylashtirib palindrom hosil qilish mumkinmi, aniqlang. Palindrom oldinga ham, orqaga ham bir xil o‘qiladi. Buning uchun toq marta uchraydigan harflar soni 0 yoki 1 bo‘lishi kerak: toq uchraydigan yagona harf o‘rtaga tushadi, qolganlari esa juft-juft bo‘lib ikki chetga taqsimlanadi.",
  statementEn: "You are given a string s of lowercase Latin letters. Determine whether its letters can be rearranged into a palindrome, a string that reads the same forwards and backwards. This is possible exactly when at most one letter occurs an odd number of times: that one letter sits in the middle and the rest pair up across the two halves.",
...
P.push({
  ...
  statementUz: "Sizga n ta butun sondan iborat massiv berilgan. U kamaymaydigan tartibda saralangan massivni biror pozitsiyaga aylantirish natijasida hosil bo‘lishi mumkinmi, aniqlang. Aylantirish nolga teng bo‘lishi ham mumkin, ya'ni allaqachon saralangan massiv ham shartni qanoatlantiradi. Buning uchun massiv bo‘ylab yurib, qo‘shnisidan kichik element necha marta uchrashini sanash kifoya.",
  statementEn: "You are given an array of n integers. Determine whether it could have been produced by rotating a non-decreasing sorted array by some amount. A rotation of zero is allowed, so an already sorted array qualifies. It is enough to walk the array and count how many times an element is smaller than the one before it.",
  inputUz: "Birinchi qatorda bitta n butun soni beriladi. Ikkinchi qatorda probel bilan ajratilgan n ta butun son keladi.",
  inputEn: "The first line contains one integer n. The second line contains n integers separated by single spaces.",
...
P.push({
  ...
  statementUz: "Sizga ikkita kamaymaydigan tartibda saralangan massiv berilgan. Ularni birlashtirganda hosil bo‘ladigan massivning medianasini toping. Birlashgan massivdagi elementlar soni toq bo‘lsa, mediana o‘rtadagi element; juft bo‘lsa, ikkita o‘rtadagi elementning kichigi olinadi. Massivlarni haqiqatan birlashtirmasdan, kesim joyini ikkilik qidiruv bilan topish mumkin.",
  statementEn: "You are given two arrays, each sorted in non-decreasing order. Find the median of the array formed by merging them. When the merged length is odd the median is the middle element; when it is even, take the smaller of the two middle elements. The cut can be found by binary search without merging the arrays at all.",
...
P.push({
  ...
  statementUz: "Sizga n ta uchi kontur bo‘ylab tartib bilan berilgan sodda ko‘pburchak va bitta P nuqtasi berilgan. P ko‘pburchakning qat'iy ichida yotadimi, aniqlang. Chegarada — biror tomon ustida yoki uchida — yotgan nuqta ichkarida hisoblanmaydi va alohida javob talab qiladi. Nuqtadan chiqqan nur konturni necha marta kesib o‘tishini sanash kifoya: toq bo‘lsa ichkarida, juft bo‘lsa tashqarida.",
  statementEn: "You are given a simple polygon by its n vertices in order around the outline, and a point P. Determine whether P lies strictly inside the polygon. A point on the boundary — on an edge or at a vertex — does not count as inside and gets an answer of its own. Counting how many times a ray from the point crosses the outline settles it: odd means inside, even means outside.",
...
P.push({
  ...
  statementUz: "Sizga n ta uchi va m ta qirrasi bo‘lgan yo‘naltirilmagan graf hamda k ranglar soni berilgan. Har bir uchga bittadan rang berib, qirra bilan bog‘langan ikki uch har xil rangda bo‘ladigan bo‘yashlar nechtaligini sanang. Ranglar bir-biridan farqlanadi, ya'ni bir xil bo‘linishning ranglari almashtirilgan varianti alohida bo‘yash hisoblanadi. n kichik bo‘lgani uchun uchlarni birma-bir bo‘yab, to‘qnashuvda orqaga qaytish kifoya.",
  statementEn: "You are given an undirected graph with n vertices and m edges, and a number of colours k. Count the colourings that give each vertex one colour so that the two ends of every edge differ. The colours are distinguishable, so the same partition with the colours swapped is a different colouring. Since n is small, colouring the vertices one at a time and backtracking on a clash is enough.",
