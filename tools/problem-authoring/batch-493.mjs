...
P.push({
  ...
  statementUz: "Sizga n ta musbat sondan iborat massiv berilgan; ular kesmalarning uzunliklari. Shunday uchliklar sonini toping-ki, o‘sha uch kesmadan uchburchak yasash mumkin bo‘lsin. Uchburchak yasash uchun har ikki tomonning yig‘indisi uchinchisidan qat'iy katta bo‘lishi kerak. Uchala pozitsiya har xil bo‘lishi shart, garchi ulardagi uzunliklar teng bo‘lishi mumkin bo‘lsa ham; yassi uchburchak sanalmaydi.",
  statementEn: "You are given an array of n positive numbers, the lengths of some segments. Count the triples from which a triangle can be built. A triangle needs the sum of every two sides to be strictly above the third. The three positions must differ, though the lengths standing at them may be equal, and a flat triangle does not count.",
...
P.push({
  ...
  statementUz: "Sizga n ta uchi bo‘lgan va 1-uchdan ildizlangan daraxt berilgan. Ildizning darajasi 0, uning bolalariniki 1 va hokazo. Eng ko‘p uch turgan darajani toping va o‘sha darajadagi uchlar sonini chiqaring. Bir nechta daraja bir xil ko‘p uch saqlasa ham, javob baribir o‘sha son bo‘ladi.",
  statementEn: "You are given a tree with n vertices, rooted at vertex 1. The root sits at level 0, its children at level 1 and so on. Find the level holding the most vertices and print how many vertices that is. If several levels tie for the most, the answer is still that count.",
...
P.push({
  ...
  statementUz: "Sizga n ta butun sondan iborat massiv berilgan. Faqat yonma-yon turgan ikkita elementni almashtirish mumkin. Massivni kamaymaydigan tartibga keltirish uchun kerak bo‘ladigan eng kam almashtirishlar sonini toping. Teng qiymatlar orasida almashtirish kerak emas va javob 32-bitli turdan oshib ketadi.",
  statementEn: "You are given an array of n integers. Only two neighbouring elements may be exchanged at a time. Find the fewest such swaps that bring the array into non-decreasing order. Equal values never need a swap between them, and the answer runs beyond a 32-bit type.",
  inputUz: "Birinchi qatorda bitta n butun soni beriladi. Ikkinchi qatorda probel bilan ajratilgan n ta butun son keladi.",
  inputEn: "The first line contains one integer n. The second line contains n integers separated by single spaces.",
...
P.push({
  ...
  statementUz: "Sizga L va R chegaralari berilgan. Shu oraliqdagi shunday sonlarni sanang-ki, ularning o‘nlik yozuvida hech ikkita qo‘shni raqam teng bo‘lmasin. Masalan 121 mos keladi, 122 esa yo‘q, chunki oxirgi ikkita raqami teng. Chegaralarning o‘zi ham oraliqqa kiradi. Bir raqamli son har doim mos keladi, chunki unda solishtiradigan qo‘shni juftlik yo‘q.",
  statementEn: "You are given bounds L and R. Count the numbers in that range whose decimal writing has no two equal neighbouring digits. For instance 121 qualifies while 122 does not, since its last two digits are equal. Both bounds belong to the range. A one-digit number always qualifies, since it has no neighbouring pair to compare.",
