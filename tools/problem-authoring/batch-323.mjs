...
P.push({
  ...
  statementUz: "Sizga n ta butun sondan iborat massiv berilgan. Har bir pozitsiya uchun undan chapda turgan va undan qat'iy katta bo‘lgan elementlar sonini hisoblang, so‘ng shu sonlarning yig‘indisini chiqaring. Har bir pozitsiya uchun faqat undan qat'iy chapda turgan elementlar qaraladi va solishtirish qat'iy, ya'ni teng qiymat sanalmaydi.",
  statementEn: "You are given an array of n integers. For every position, count the elements standing to its left that are strictly greater than it, then print the sum of those counts. Only the elements standing strictly to the left of a position are looked at, and the comparison is strict, so an equal value is not counted.",
  inputUz: "Birinchi qatorda bitta n butun soni beriladi. Ikkinchi qatorda probel bilan ajratilgan n ta butun son keladi.",
  inputEn: "The first line contains one integer n. The second line contains n integers separated by single spaces.",
